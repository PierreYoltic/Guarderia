...
Public Class FrmSuspensiones
    ...
    Private Sub FrmSuspensiones_Load(sender As Object, e As EventArgs) Handles Me.Load
        conexion.Open()
    ...
    Private Sub BtnNuevo_Click(sender As Object, e As EventArgs) Handles BtnNuevo.Click
        ...
        comando.CommandText = "SELECT COUNT(*) FROM Suspensiones"
        N = comando.ExecuteScalar + 1
        TxtIdSuspensiones.Text = N
    End Sub
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        Dim R As String
        R = "INSERT INTO Suspensiones
            VALUES(" & Val(TxtIdSuspensiones.Text) & "," & Val(TxtIdMenor.Text) & ",'" & DTP_Fecha.Text & "','" & TxtFechaInicio.Text & "','" & TxtFechaFin.Text & "','" & TxtMotivo.Text & "')"
        MsgBox(R)
        comando.CommandText = R
